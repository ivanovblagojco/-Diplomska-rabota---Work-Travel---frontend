...
import { faArchive, faCashRegister, faHome, faInbox, faInfo, faInfoCircle, faNewspaper, faPlus, faRegistered, faSignInAlt, faSignOutAlt, faUser, faUserEdit, faUserPlus } from "@fortawesome/free-solid-svg-icons";
...
class Navbar extends Component{
    render() {
        ...
        return (
            <div className="App">
                <nav class="mb-1 navbar navbar-expand-lg navbar-dark default-color fixed-top" style={{background:"linear-gradient(to right, #03A9F4, #1F75FE, #03A9F4)"}}>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent-3">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link waves-effect waves-light" href="/createPost"><FontAwesomeIcon icon={faPlus} /> Креирај објава</a>
                            </li>
                            <li class="nav-item">
